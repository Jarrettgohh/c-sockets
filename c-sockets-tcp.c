...
int main()
{
        ...
        while (1)
        {
                ...
                // char *payload = "<html><body><img src=\"https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Anonymous.svg/800px-Anonymous.svg.png\" style=\"width:400px;height:400px\"/>hello friend, its your friendly neighbourhood hacker...</body></html>i";

                // char *payload_len;
                // sprintf(payload_len, "%li", strlen(payload));
